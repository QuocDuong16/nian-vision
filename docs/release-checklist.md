...
- [ ] Create a new immutable prerelease tag exactly matching the RC source version, currently `v1.0.0-rc.25`. Never move, delete or reuse any consumed tag `v1.0.0-rc.1` through `v1.0.0-rc.24`; source/tag cross-pairing is forbidden.
