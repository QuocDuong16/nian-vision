...
- **Events:** v1 recognizes the accepted standard CellMotion path and stores normalized MotionStarted/MotionEnded history. There is no AI/person/object detection, analytics configuration, motion-triggered recording, generated event clips or thumbnails.
